  ...
  const mockSessions: TutoringSession[] = [
    {
      name: 'Tutor A',
      classNumber: '1010',
      start: DateTime.local(2023, 1, 10, 10).setZone('America/Los_Angeles'),
      end: DateTime.local(2023, 1, 10, 11).setZone('America/Los_Angeles'),
    },
    {
      name: 'Tutor B',
      classNumber: '1010',
      start: DateTime.local(2023, 1, 10, 12).setZone('America/Los_Angeles'),
      end: DateTime.local(2023, 1, 10, 14).setZone('America/Los_Angeles'),
    },
    {
      name: 'Tutor C',
      classNumber: '1010',
      start: DateTime.local(2023, 1, 10, 13).setZone('America/Los_Angeles'),
      end: DateTime.local(2023, 1, 10, 16).setZone('America/Los_Angeles'),
    },
  ]
  ...
  const mockSessions: TutoringSession[] = [
    {
      ...
      name: 'Tutor A',
      classNumber: '1010',
      start: DateTime.local().setZone('America/Los_Angeles').minus({ minutes: 30 }),
      end: DateTime.local().setZone('America/Los_Angeles').plus({ minutes: 30 }),
    },
    {
      // upcoming session
      name: 'Tutor B',
      classNumber: '1010',
      start: DateTime.local().setZone('America/Los_Angeles').plus({ minutes: 30 }),
      end: DateTime.local().setZone('America/Los_Angeles').plus({ minutes: 90 }),
    },
  ]
  ...
  const mockSessions: TutoringSession[] = [
    {
      ...
      name: 'Tutor A',
      classNumber: '1010',
      start: DateTime.local().setZone('America/Los_Angeles').plus({ days: 1 }),
      end: DateTime.local().setZone('America/Los_Angeles').plus({ days: 1, hours: 1 }),
    },
  ]
